...
session.setAttribute("pid",session.getAttribute("ID"));
%>
    ...
    <div class="app">
		<aside class="nav">
			...
			<ul class="menu">
				...
				</span><a class="nav__link" href="healthInfo.html">Add health Details</a></li>
				<li class="menu__item"><span class="menu__icon"> <svg
							width="23" height="22" fill="none"
							xmlns="http://www.w3.org/2000/svg">
                            <path
				...
				</span><a class="nav__link" href="feedback.html">Feedback</a></li>
				<li class="menu__item"><span class="menu__icon"> <svg
							width="23" height="22" fill="none"
							xmlns="http://www.w3.org/2000/svg">
                            <path
				...
				</span><a class="nav__link" href="Payment1.html">Payment</a></li>
			...
			<div class="team">
				...
				<div class="team__setting">
					<button class="btn btn--primary">
						<a class="nav__link" href="Consultatio.html"> Book appointment
						</a>
					</button>
					<button class="btn btn--primary">
					...
					<button class="btn btn--primary" >
						<a class="nav__link" href="prescption.jsp"> Prescription </a>
					</button>
